...
/home/bbales2/modal_cpp/models/cubic_w_rotations sample algorithm=hmc engine=nuts max_depth=7 num_samples=1000 num_warmup=1000 save_warmup=1 data file=input.dat output file=$PBS_JOBID.csv refresh=1
"""
